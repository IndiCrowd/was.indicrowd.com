...
<link href="<c:url value="/css/timeline-screen.css"/>" rel="stylesheet" type="text/css">

<div id="timelineContainer" style="margin-top:100px">
...
<script src="<c:url value="/js/timeliner.min.js" />"></script>
<script>
	$.timeliner();
</script>